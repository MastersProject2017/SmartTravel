...
public class Auth extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signin = (TextView) findViewById(R.id.textiewSignin);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(Auth.this, "Registered Successfull", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(Auth.this, "Registered Unsuccessfull. Please try again!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
